...
output1.out = () => sigmoid(output1.net());
...
output2.out = () => sigmoid(output2.net());
...
hidden1.out = () => sigmoid(hidden1.net());
...
hidden2.out = () => sigmoid(hidden2.net());
...
weight1.error = () => hidden1.error() * hidden1.change() * input1.out();
weight1.next = () => weight1.value - learningRate * weight1.error();

weight2.error = () => hidden1.error() * hidden1.change() * input2.out();
weight2.next = () => weight2.value - learningRate * weight2.error();

weight3.error = () => hidden2.error() * hidden2.change() * input1.out();
weight3.next = () => weight3.value - learningRate * weight3.error();

weight4.error = () => hidden2.error() * hidden2.change() * input2.out();
weight4.next = () => weight4.value - learningRate * weight4.error();

weight5.error = () => output1.error() * output1.change() * hidden1.out();
weight5.next = () => weight5.value - learningRate * weight5.error();

weight6.error = () => output1.error() * output1.change() * hidden2.out();
weight6.next = () => weight6.value - learningRate * weight6.error();

weight7.error = () => output2.error() * output2.change() * hidden1.out();
weight7.next = () => weight7.value - learningRate * weight7.error();

weight8.error = () => output2.error() * output2.change() * hidden2.out();
